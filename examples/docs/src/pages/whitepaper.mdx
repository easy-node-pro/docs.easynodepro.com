...
Whitepaper Version 1.3.2 - February 8th, 2025
...
- **Token Burn:** We currently buy and burn as we spend validator rewards.
  - Monthly burns to help the `$ENP` LP pools grow will go thorugh at least January 2027!
  - We will use 25%+ of the EasyNodePro valiator rewards Monthly to buy/burn `$ENP` through at least January 2027!
...
- Air drop target - Determine validator to target for stake weighted air drop.
...
## Links
 ...
 5. **Snapshot Voting Portal:** [Snapshot.org](https://snapshot.box/#/s:easynodepro.eth)
