...
## Public Donations & Burn

If you'd like to donate your $ENP, $MONA, $ONE or any other Harmony Protocol token to our project, send it to our LP hot wallet at `0x3c0e1A58556d1490Bb0923D8c47A766B7A491b10` and we will use it in compounding LP rewards for the community!  

If you would like us to officially burn $ENP to reduce the supply fill out a ticket in discord with the transaction to our hot wallet and we'll burn those tokens reducing supply!  
