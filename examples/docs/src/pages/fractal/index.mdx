# Fractal Validator Guides
![Fractal Logo](/findora_logo_white.png)

## What is a Fractal Validator?
Like most EVM type validators, Fractal validators are responsible for processing the blocks. The validator who proposes the block on Fractal gets the reward. Here's some differences for those familiar with Harmony ONE:
- 21 day unstaking
...
## How to be a Fractal Validator?
Start by having at least 10k Fractal in a wallet you control. After reading up on how to run a validator you can rent a VPS (Virutal Private Server) or depending on skill level find an Ubuntu server to run Fractal. Once you've setup the software you're in the post installation phase where you'll monitor your server (use [vStatsFindoraBot](https://t.me/vStatsFindoraBot) on telegram) and start working to obtain a higher total delegation to earn more rewards.
...
-  Setup a user account to run docker & fractal
    -  Don't use `root` or `fractal` as account names!!!
