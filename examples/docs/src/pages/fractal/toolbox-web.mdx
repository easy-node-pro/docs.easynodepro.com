...
A web interface for the [fractal-toolbox](https://github.com/FindoraNetwork/fractal-toolbox) for Fractal Validators.

## Web Stats

Would you like to go to a web page on your validator server to get your stats? This is it!

![fractal-toolbox-web ui shot](/fractal-web-main.png)

## Install Web UI

The web files now come inside toolbox in the `~/fractal-toolbox/web` directory!
...
![fractal-web-stats service](/fractal-web-status.png)
...
Find all of our socials on [EasyNodePro.com](https://easynodepro.com) if you have any questions.
